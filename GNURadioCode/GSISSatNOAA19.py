...
class GSISSatNOAA19(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GSISSatNOAA19")
        ...
        self.osmosdr_source_1.set_center_freq(137.1*1e6, 0)
...
def main(top_block_cls=GSISSatNOAA19, options=None):
