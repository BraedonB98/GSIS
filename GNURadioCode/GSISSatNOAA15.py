...
class GSISSatNOAA15(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "GSISSatNOAA15")
        ...
        self.osmosdr_source_1.set_center_freq(137.62*1e6, 0)
...
def main(top_block_cls=GSISSatNOAA15, options=None):
